  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v93-hero-width-specificity" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v93-hero-width-specificity" />
        <script src="/assets/js/main.js?v=v93-hero-width-specificity" defer></script>
