  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v95-hero-uncrop-blue-copy" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v95-hero-uncrop-blue-copy" />
        <script src="/assets/js/main.js?v=v95-hero-uncrop-blue-copy" defer></script>
