  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v91-hero-wider-fewer-lines" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v91-hero-wider-fewer-lines" />
        <script src="/assets/js/main.js?v=v91-hero-wider-fewer-lines" defer></script>
