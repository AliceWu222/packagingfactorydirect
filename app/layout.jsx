  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v86-hero-98vw" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v86-hero-98vw" />
        <script src="/assets/js/main.js?v=v86-hero-98vw" defer></script>
