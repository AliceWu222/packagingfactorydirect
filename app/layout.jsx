  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v81-logo-fix" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v81-logo-fix" />
        <script src="/assets/js/main.js?v=v81-logo-fix" defer></script>
