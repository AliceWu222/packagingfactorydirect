  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href="/assets/css/style.css?v=v92-redframe-visible" as="style" />
        <link rel="stylesheet" href="/assets/css/style.css?v=v92-redframe-visible" />
        <script src="/assets/js/main.js?v=v92-redframe-visible" defer></script>
